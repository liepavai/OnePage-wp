...
// Pridedame paveiksliuko dydį

add_image_size('logo', 123, 123);
add_image_size('column-icon', 40, 40, true);
...
function theme_scripts(){
  ...
  //       wp_deregister_script('jquery');
        ...
        wp_register_script('stickyfill-min-js', ASSETS_URL . '/assets/scripts/stickyfill.min.js', array('jquery'), '1.0', true);
        wp_register_script('masonry-pkgd-min-js', ASSETS_URL . '/assets/scripts/masonry.pkgd.min.js', array('jquery'), '1.0', true);
        wp_register_script('custom-js', ASSETS_URL . '/assets/scripts/custom.js', array('jquery'), '1.0', true);
        wp_register_script('menu-js', ASSETS_URL . '/assets/scripts/menu.js', array('jquery'), '1.0', true);

        wp_enqueue_script('jquery');
        wp_enqueue_script('stickyfill-min-js');
